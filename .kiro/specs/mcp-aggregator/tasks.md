...
- [ ] 1.1 (P) Implement Zod Schema & Type Definitions
...
- [ ] 1.2 (P) Implement Configuration Loader with XDG Support
...
- [ ] 2.1 (P) Implement UpstreamClient Connection Management
...
- [ ] 2.2 (P) Implement Upstream Tool/Resource Accessors
...
- [ ] 3.1 Implement Namespace & Prefix Logic
...
- [ ] 3.3 Implement Dispatch Routing
...
- [ ] 4.1 (P) Implement Stdio Server Transport
...
- [ ] 4.2 (P) Implement Hono SSE Server Transport
...
- [ ] 5.2 Implement Main Entry Point & Integration
